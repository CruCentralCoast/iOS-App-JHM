...
class CruColors {
    static let yellow = UIColor(red: 0.976, green: 0.714, blue: 0.145, alpha: 1.0) //249, 182, 37
    ...
    static let lightBlue = UIColor(red: 0.243, green: 0.694, blue: 0.784, alpha: 1.0) //62, 177, 199
}
