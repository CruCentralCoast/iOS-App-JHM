...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-CruTests/HTMLReader.framework"
  install_framework "Pods-CruTests/IQKeyboardManagerSwift.framework"
  install_framework "Pods-CruTests/ImageLoader.framework"
  ...
  install_framework "Pods-CruTests/SwiftyJSON.framework"
fi
